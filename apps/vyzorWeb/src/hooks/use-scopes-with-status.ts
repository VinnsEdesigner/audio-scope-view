/**
 * DRAFT: Scope with Status Hooks
 *
 * Extended scope hooks that include status (live/paused/offline).
 * Used for the Home page Active Scopes list.
 */
...
export function useActiveScopesWithStatus() {
  return useQuery<ScopeWithStatus[]>({
    ...
    staleTime: 15 * 1000, // More frequent updates for active scopes
  });
}
...
// ============================================
// DERIVED HOOKS (For Home Page Convenience)
// ============================================

/**
 * Convenience hook for the Home page Active Scopes card
 * Returns active scopes with status
 */
