// use-sessions.ts — verbatim port of the web hook. Consumes only @apollo/client
// + the transport-agnostic gql operations from @audio-scope-view/api-client, so
// it works unchanged under the RN Apollo provider (app/lib/apollo-client.ts).
