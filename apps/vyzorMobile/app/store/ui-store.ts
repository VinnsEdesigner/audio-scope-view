// ui-store.ts — verbatim port of the web ui-store. It is pure state with no
// browser APIs; the browser bits (matchMedia for isMobile/isTablet, document
// for theme) live in the use-mobile / use-theme hooks instead. Persisted
// display/trigger/scope-view fields survive restarts via AsyncStorage.
