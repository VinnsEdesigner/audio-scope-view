/**
 * DRAFT: Recording Transforms
 *
 * Transforms server snake_case responses to camelCase domain types.
 */
...
// ============================================
// REVERSE TRANSFORMS (Domain to Server)
// ============================================
