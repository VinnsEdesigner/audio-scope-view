...
export function transformRecording(server: RecordingServer): Recording {
  return {
    ...
    peakDb: server.peakDb,
    rmsDb: server.rmsDb,
    dcOffset: server.dcOffset,
    dominantFrequency: server.dominantFrequency,
    frequencyHigh: server.frequencyHigh,
    frequencyLow: server.frequencyLow,
    bitDepth: server.bitDepth,
...
export function transformRecordingSummary(server: RecordingSummaryServer): RecordingSummary {
  return {
    ...
    peakDb: server.peakDb,
    rmsDb: server.rmsDb,
    peakNegativeDb: server.peakNegativeDb,
    dcOffset: server.dcOffset,
    dominantFrequency: server.dominantFrequency,
    frequencyHigh: server.frequencyHigh,
    frequencyLow: server.frequencyLow,
